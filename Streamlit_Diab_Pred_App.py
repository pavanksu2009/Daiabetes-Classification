...
def main():
    ...
    preg = st.number_input('Number of times person is pregnant: ', min_value= 0, max_value= 17, value= 0)
    ...
    age =  st.number_input('Age (years): ', min_value= 21, max_value= 81, value= 21)
    output = ''
